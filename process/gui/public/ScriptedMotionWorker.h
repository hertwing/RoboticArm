...
private:
    ...
    std::unique_ptr<odin::shmem_wrapper::ShmemHandler<ScriptedMotionStepStatus>> m_scripted_motion_request_shmem_handler;
    std::unique_ptr<odin::shmem_wrapper::ShmemHandler<ScriptedMotionStepStatus>> m_scripted_motion_reply_shmem_handler;
