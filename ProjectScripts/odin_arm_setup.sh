...
set_static_ip_if_missing "eth0"  "192.168.72.2/24" "192.168.1.1" "192.168.1.1 8.8.8.8"
set_static_ip_if_missing "wlan0" "192.168.72.102/24" "192.168.1.1" "192.168.1.1 8.8.8.8"

### Add gui to arm hosts
HOSTS="/etc/hosts"
IP="192.168.72.101"
NAME="OdinGui"
